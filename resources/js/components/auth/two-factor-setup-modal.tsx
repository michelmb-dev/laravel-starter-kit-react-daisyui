                            ...
                            {!manualSetupKey ? (
                                ...
                                <>
                                    ...
                                    <button
                                        ...
                                        className="border-border border-l px-3 hover:bg-secondary/40"
                                    >
...
export default function TwoFactorSetupModal({
    ...
    return (
        <Dialog open={isOpen} onOpenChange={(open) => !open && handleClose()}>
            <DialogBox className="space-y-4 border border-neutral sm:max-w-md">
                <div className="flex items-center justify-center gap-4">
                    <QrCode size={48} />
                    <h2 className="text-xl font-bold text-nowrap text-neutral-content">
                        {modalConfig.title}
                    </h2>
                </div>
                <p className="text-center">{modalConfig.description}</p>
